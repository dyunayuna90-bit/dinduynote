    ...
    >
       ...
       <AnimatePresence>
           {selectedImgId && (
               ...
               >
                   <div className={`flex flex-col p-2 gap-1 min-w-[180px] rounded-2xl shadow-xl border border-black/5 ${isDark ? 'bg-zinc-900 text-white border-zinc-700' : 'bg-white text-zinc-900 border-zinc-200'}`}>
