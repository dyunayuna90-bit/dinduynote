...
import { 
  ...
  // UI Icons
  Trash2, Archive, Grid, Layout, Clock, AlertTriangle, Layers, Share2, MoreVertical
} from 'lucide-react';
...
export const ICONS: Record<string, React.ElementType> = {
  ...
  'scissors': Scissors, 'trash': Trash2, 'archive': Archive, 'clock': Clock, 'alert': AlertTriangle,
  'layers': Layers, 'layout': Layout, 'share': Share2, 'more': MoreVertical,
  // Science & Academic
