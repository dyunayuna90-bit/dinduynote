...
// --- FIX 1: ANTI-JITTER VISUAL VIEWPORT HOOK ---
// Ini versi V 1.7 yang sudah di-optimalkan biar ga geter/kedutan.
// Kita pake requestAnimationFrame buat sinkronisasi posisi toolbar dengan keyboard.
const useVisualViewport = () => {
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      // Pake requestAnimationFrame biar smooth dan ga jitter
...
const NoteEditor = ({ note, onUpdate, onClose, onDelete, isDark, showSettings, onCloseSettings, onOpenSettings }: any) => {
  ...
  return (
    // ANTI-JITTER CONTAINER: Fixed position + dynamic viewport size
    <div 
        className={`fixed left-0 w-full z-[100] flex flex-col ${themeClass}`}
        style={{ 
            height: viewportHeight, // Sinkron sama viewport visible area
            top: offsetTop, // Handle scroll offset
            transition: 'height 0.1s ease-out' // Smooth transition biar ga kaget
        }}
    >
...
// --- Header Component (FIX 2: Z-INDEX 60 = RAJA TERAKHIR) ---
const Header = ({ 
    ...
    // Z-INDEX 60 AGAR SELALU DIATAS PEEKING NOTE
    return (
    ...
    <div className="pb-32 max-w-7xl mx-auto" onClick={() => { setExpandedFolderId(null); }}>
      ...
      <div className="px-4 mt-2">
        <LayoutGroup>
            ...
            {/* Folders - Z-INDEX 40 (Below Peeking) */}
...
const FolderItem = ({ 
  ...
  return (
    <motion.div 
       ...
       // Z-INDEX 40 SAAT EXPANDED (Di bawah Peeking 50)
                ...
                <div className={`p-5 flex flex-col ${isExpanded ? '' : 'h-full'}`}>
                    <div className="flex justify-between items-start mb-2">
                         <div className="pr-2 relative flex-1">
                             ...
                             {/* FIX 3: BINTANG PINDAH KANAN ATAS */}
...
const NoteCard = ({ note, onClick, onDelete, onRestore, inFolder, isDark, colors, isSelected, isSelectionMode, isPeeking, onPeek, searchQuery, isTrash, onLongPress }: any) => {
  ...
  return (
    <motion.div 
       ...
       onPointerUp={handlePointerUp}
       onPointerLeave={handlePointerUp}
       // FIX 2: Z-INDEX 50 FOR PEEKING (Lower than Header 60)
