  ...
  return (
    ...
    >
        <div className="relative w-full h-full rounded-3xl">
            ...
            >
                <div className="p-5 flex flex-col h-full"> {/* Reduced padding to p-5 */}
                    <div className="flex justify-between items-start mb-2">
                        <h2 className="text-2xl font-bold leading-tight line-clamp-2 pr-2">{folder.name}</h2> {/* Line Clamp 2 */}
